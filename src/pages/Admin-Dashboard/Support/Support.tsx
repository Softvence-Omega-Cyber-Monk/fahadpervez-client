...
const MOCK_TICKETS: Ticket[] = [
  ...
  },
  {
    ...
    status: "Resolved",
    userMessage:
      "I can't log into my account, my password reset link is expired.",
    from: "Maria Smith",
  },
  {
    id: "001236",
    ...
    date: "17/10/2023",
    status: "Resolved",
    userMessage: "Please verify my account so I can access premium features.",
    from: "David Brown",
  },
  {
    id: "001237",
    ...
    status: "Pending",
    userMessage:
      "My delivery tracking hasn't updated in 3 days. What's going on?",
    from: "Emily Davis",
  },
  {
    id: "001238",
    ...
    date: "19/10/2023",
    status: "Resolved",
    userMessage: "I need to update my billing address for the next cycle.",
    from: "Michael Wilson",
  },
  {
    id: "001239",
    ...
    date: "20/10/2023",
    status: "Pending",
    userMessage: "I keep getting a 404 error when I try to reset my password.",
    from: "Sarah Taylor",
  },
];
...
const TicketModal: React.FC<{ ticket: Ticket; onClose: () => void }> = ({
  ticket,
  onClose,
}) => {
  ...
  return (
    <div className="min-h-screen  p-4 sm:p-8 font-['Inter']">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:hidden mb-10">
        {tickets.map((ticket) => (
          <div key={ticket.id} className="bg-white rounded-xl shadow-lg border border-gray-100 p-4 space-y-3">
            ...
            <div className="text-sm text-gray-600 border-t border-b border-gray-100 py-2">
              <p><span className="font-medium text-gray-700">User:</span> {ticket.user}</p>
              <p><span className="font-medium text-gray-700">Date:</span> {ticket.date}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
          ...
          <div className="flex justify-end mt-4">
            <button
              ...
              onClick={() =>
                console.log("Auto reply template saved:", autoReplyTemplate)
              }
              className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg shadow-md transition duration-200"
            >
              Save changes
