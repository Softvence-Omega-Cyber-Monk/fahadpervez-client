...
const SideBar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed md:static top-0 left-0 z-50 bg-white min-w-64  rounded-none md:rounded-lg shadow-md p-4 flex flex-col justify-between transform transition-transform duration-300 mt-12
