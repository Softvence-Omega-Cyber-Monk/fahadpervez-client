    ...
    <div className="space-y-6">
      <div className="pb-8 border-b border-gray-100">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="text-blue-600 hover:text-blue-700 text-sm font-medium">Change profile</button>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" placeholder='Gladys Richards' className="w-full p-3 bg-blue-50 border-0 rounded-lg text-gray-900" />
          </div>
          <div>
            <label className="block text-sm text-gray-700 mb-2">Phone</label>
            <input type="tel" placeholder="(671) 555-0110" className="w-full p-3 bg-blue-50 border-0 rounded-lg text-gray-900" />
          </div>
          <div>
            <label className="block text-sm text-gray-700 mb-2">E-mail</label>
            <input type="email" placeholder="debra.holt@example.com" className="w-full p-3 bg-blue-50 border-0 rounded-lg text-gray-900" />
          </div>
          <div>
            <label className="block text-sm text-gray-700 mb-2">Country</label>
            <select defaultValue="USA" className="w-full p-3 bg-blue-50 border-0 rounded-lg text-gray-900">
              <option>USA</option>
            </select>
          </div>
          <div className="col-span-2">
            <label className="block text-sm text-gray-700 mb-2">Language</label>
            <select defaultValue="English" className="w-full p-3 bg-blue-50 border-0 rounded-lg text-gray-900">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2">
            ...
            <input type="text" placeholder="The Walt Disney Company" className="w-full p-3 bg-blue-50 border-0 rounded-lg text-gray-900" />
          </div>
          <div>
            <label className="block text-sm text-gray-700 mb-2">Business type</label>
            <input type="text" placeholder="Entertainment" className="w-full p-3 bg-blue-50 border-0 rounded-lg text-gray-900" />
          </div>
          <div>
            <label className="block text-sm text-gray-700 mb-2">Phone</label>
            <input type="tel" placeholder="(671) 555-0110" className="w-full p-3 bg-blue-50 border-0 rounded-lg text-gray-900" />
