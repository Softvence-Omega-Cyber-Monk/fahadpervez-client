...
const SaveButton = ({ type, children, onClick }: SaveButtonProps) => (
  <button
    onClick={onClick}
    className={`
      px-6 py-2.5 rounded-lg font-medium text-white text-sm transition-all
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                <label
                  key={item.label}
                  className="flex items-start p-3 bg-blue-50 rounded-lg cursor-pointer hover:bg-blue-100 transition-colors"
                >
                  <input
                    type="checkbox"
