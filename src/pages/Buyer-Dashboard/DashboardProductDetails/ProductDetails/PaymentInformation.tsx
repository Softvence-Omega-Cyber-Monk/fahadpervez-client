...
export default function PaymentInformation() {
  return (
    <div className="w-full bg-white p-6 sm:p-8 border-gray-100 border-1 rounded-md mt-6">
      {/* Header with Edit Button */}
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-medium text-gray-900">Payment Information</h2>
